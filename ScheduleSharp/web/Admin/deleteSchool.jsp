...
<html lang="en">
    ...
    <body>
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    ...
                    <li>
                        <div id="addSchoolButton" class="navbar-right">
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#deleteSchool">Delete School</button>
                        </div>
                    </li>
                </div>
            </div>
        ...
        <div id="deleteSchool" name="deleteSchool" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        ...
        <!-- CUSTOM JS FILE(S)-->
        <script src="./bootstrap/js/deleteSchool.js"></script>
    </body>
</html>
